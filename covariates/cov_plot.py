...
def plot_coviariates(qualities, labels, fig_name, save=True, show=True, fill=True, histtype='bar', bins=30, alpha=0.75):
...
if __name__ == "__main__":
    ...
    plot_coviariates(qualities, labels, 'cov_facial_hair', show=False, histtype='step', fill=False)
